...
uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     [MAC_FN] = LAYOUT_ansi_84(
          ...
          KC_TRNS,  S(KC_1),  0,        S(KC_3),  S(KC_4),  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_PGDN,
          KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  BL_DOWN,  BL_UP,    BL_STEP,  BL_TOGG,  KC_TRNS,            KC_TRNS,            KC_HOME,
          KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  BAT_LVL,  NK_TOGG,  KC_TRNS,  BT_HST1,  BT_HST2,  BT_HST3,            KC_TRNS,  KC_TRNS,  KC_END,
